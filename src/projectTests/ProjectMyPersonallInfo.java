...
public class ProjectMyPersonallInfo extends ProjectBaseTests{
	...
	public void updatePersonallInfo() {
		...
		myPersonallInfo.insertData(myPersonallInfo.getCurrentPassword(), excelReader.getStringData("MyPersonalInfo", 11, 3));
		myPersonallInfo.insertData(myPersonallInfo.getNewPassword(), excelReader.getStringData("MyPersonalInfo", 12, 3));
		myPersonallInfo.insertData(myPersonallInfo.getCurrentPassword(), excelReader.getStringData("MyPersonalInfo", 13, 3));
